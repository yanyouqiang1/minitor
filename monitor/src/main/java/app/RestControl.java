...
public class RestControl {
    ...
    public Details_group Details_group(@PathVariable(name = "id") int id, @RequestParam(name = "page", defaultValue = "0")int page, @RequestParam(name = "size",defaultValue = "10")int size){
        return restInter.details_group(id,page,size);
    }

    @RequestMapping("/resources/{id}/monitor_details")
    public Details_resources Details_resources(@PathVariable(name = "id") int id, @RequestParam(name = "page", defaultValue = "0")int page, @RequestParam(name = "size",defaultValue = "10")int size){
