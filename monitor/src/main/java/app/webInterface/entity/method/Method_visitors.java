...
public class Method_visitors {
    ...
    public void generate(List<Monitor_method> methods){
        ...
        for(int i=0;i<size;i++){
            method_visitors[i] = methods.get(i).getVisitors();
        }
    }

    public long[] getMethod_visitors() {
        return method_visitors;
    }

    public void setMethod_visitors(long[] method_visitors) {
        this.method_visitors = method_visitors;
    }
}
